...
private:
    ...
    void createInstance()
    {
        ...
        {
            std::cout << "Checking for " << glfwExtensions[i] << " extension"
                      << std::endl;
    ...
    bool checkValidationLayerSupport()
    {
        ...
        // Display available validation layers
        ...
        {
            std::cout << "Checking for " << layerName << " validation layer"
                      << std::endl;
    ...
    bool isDeviceSuitable(VkPhysicalDevice device)
    {
        ...
        std::cout << "Checking if " << deviceProperties.deviceName
                  << " is suitable" << std::endl;
    ...
    QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device)
    {
        ...
        vkGetPhysicalDeviceQueueFamilyProperties(device, &familyQueueCount,
                                                 nullptr);

        std::vector<VkQueueFamilyProperties> queueFamilies(familyQueueCount);
    ...
    void createLogicalDevice()
    {
        ...
        for (uint32_t queueFamily : uniqueQueueFamilies)
        {
            ...
            queueCreateInfo.queueFamilyIndex = queueFamily; //CHANGED HERE
    ...
    void createCommandBuffers()
    {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++)
        {
            ...
            if (vkBeginCommandBuffer(commandBuffers[i],
